...
@section('breadcrumb')
    ...
    <a href="{{ route('admin.survey.internal.hasil', ['periode' => $periode]) }}">Hasil Survey Internal</a>
    <span style="margin:0 6px;color:var(--ink3)">/</span>
...
<div class="sid-topbar">
    ...
    <a href="{{ route('admin.survey.internal.hasil', ['periode' => $periode]) }}" class="sid-btn sid-btn-secondary">
        ← Kembali ke Rekap
    </a>
</div>
